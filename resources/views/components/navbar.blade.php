<header class="bg-white/80 backdrop-blur-lg shadow-sm h-16 flex items-center justify-between px-8 sticky top-0 z-10 border-b border-gray-100">
    ...
    <div>
        ...
        <p class="text-xs text-gray-400 mt-0.5">{{ now()->isoFormat('dddd, D MMMM YYYY') }}</p>
    </div>
    ...
    <div class="flex items-center gap-4">
        ...
        {{-- User Menu --}}
        <div class="flex items-center gap-3 px-3 py-2 bg-gray-50 rounded-xl">
